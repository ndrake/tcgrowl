...
public class TCGrowlSettingsController extends BaseController {
    ...
    private void doAction(final HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            GrowlRegistrations registrations = g.getRegistrations(GrowlNotifier.APP_NAME);
            registrations.registerNotification(GrowlNotifier.APP_NAME, true);

            g.sendNotification(new GrowlNotification(GrowlNotifier.APP_NAME, 
